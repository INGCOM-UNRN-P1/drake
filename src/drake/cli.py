...
def doctor_cmd(
    ...
    diagnostico.append({
        ...
        "requerido": True,
        "detalle": gcc_path or "No encontrado (requerido para compilar fuentes C para fuzzing)",
    })
    ...
    tabla = Table(title="🏥 Diagnóstico del Entorno DRAKE (doctor)", border_style="cyan")
